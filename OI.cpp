...
OI::OI() {
	...
	elbowJoystick = new Joystick(2);
	 ...
	 Button5 = new JoystickButton(elbowJoystick, 5);
	 Button5->WhileHeld(new Rotateright());
	button4 = new JoystickButton(elbowJoystick, 4);
	button4->WhileHeld(new Rotateleft());
	button3 = new JoystickButton(elbowJoystick, 3);
	button3->WhileHeld(new outfingers());
	button2 = new JoystickButton(elbowJoystick, 2);
	button2->WhileHeld(new Infingers());
	...
	SmartDashboard::PutData("Infingers", new Infingers());
	SmartDashboard::PutData("outfingers", new outfingers());
